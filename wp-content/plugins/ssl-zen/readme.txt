...
Note: The free version requires you to manually verify your domain name with [Let's Encrypt](https://letsencrypt.org) by uploading a file on your server. You will also need to upload the SSL certificate on your server and configure them.
SSL certificate from Let's Encrypt is only valid for [90 days](https://letsencrypt.org/2015/11/09/why-90-days.html) and need to be manually renewed. If you fail to renew, your website will start showing a not secure warning to the visitors.
