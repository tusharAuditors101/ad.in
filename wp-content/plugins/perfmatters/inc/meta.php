...
function perfmatters_add_meta_box() {
	...
	if(!empty($perfmatters_options['assets']['defer_js']) || !empty($perfmatters_options['lazyload']['lazy_loading']) || !empty($perfmatters_options['lazyload']['lazy_loading_iframes']) || !empty($perfmatters_options['preload']['instant_page'])) {
