...
function learndash_30_get_currency_symbol() {
	...
	if ( defined( 'LEARNDASH_STRIPE_VERSION' ) && array_key_exists( 'enabled', $stripe_settings ) && 'yes' === $stripe_settings['enabled'] && ! empty( $stripe_settings ) && ! empty( $stripe_settings['currency'] ) ) {
