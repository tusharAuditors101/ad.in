(function ($) {
    ...
    $(document).ready(function () {
        ...
        let ays_quiz_title_text_shadow_color = {
            change: function (e) {
                setTimeout(function () {
                    $(document).find('.ays-quiz-live-container .ays-quiz-live-title').css({'text-shadow': '2px 2px 2px' + e.target.value});
                }, 1);
            }
        };
        ...
        if($(document).find('#ays_quiz_enable_title_text_shadow').prop('checked')){
            $(document).find('.ays-quiz-live-container .ays-quiz-live-title').css({'text-shadow': '2px 2px 2px ' + $(document).find('#ays_quiz_title_text_shadow_color').val()});
        }else{
            $(document).find('.ays-quiz-live-container .ays-quiz-live-title').css({'text-shadow': 'none'});
        }
        $(document).find('#ays_quiz_enable_title_text_shadow').on('change', function () {
