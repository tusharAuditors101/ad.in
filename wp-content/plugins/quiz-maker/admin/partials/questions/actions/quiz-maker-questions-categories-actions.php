    ...
    <div class="container-fluid">
        ...
        <form class="ays-quiz-category-form" id="ays-quiz-category-form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class='ays-text-input' id='ays-title' name='ays_title' required type='text' value='<?php echo (stripslashes(esc_attr($question_category['title']))); ?>'>
                </div>
            </div>
            ...
            <div class='ays-field'>
                ...
                <?php
                $content = stripslashes( $question_category['description'] );
